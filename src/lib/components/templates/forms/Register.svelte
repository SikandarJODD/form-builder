...
<Card.Root class="h-fit w-full md:w-96">
	<Card.Header class="space-y-1">
		...
		<Card.Description>Create a new account by filling out the form below.</Card.Description>
	</Card.Header>
	<form method="post" use:enhance>
		<Card.Content class="grid space-y-3 pt-2">
			<div>
				<Label for="full_name" class={$errors.full_name && 'text-destructive'}>Full Name</Label>
				<Input
					type="text"
					id="full_name"
					name="full_name"
			...
			<div>
				<Label for="phone" class={$errors.phone && 'text-destructive'}>Phone number</Label>
				<PhoneInput
					country="IN"
					name="phone"
			...
			<p class="text-center text-muted-foreground">
				Already have an account? <a href="#" class="text-primary underline">Login</a>
			</p>
		</Card.Content>
	</form>
</Card.Root>

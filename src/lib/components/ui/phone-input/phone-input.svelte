...
<div class="flex place-items-center">
	...
	<TelInput
		...
		required
		class={cn(
			'flex h-9 max-w-[212px] min-w-0 rounded-lg rounded-l-none border border-l-0 border-input bg-background px-3 py-2 ring-offset-background file:border-0 file:bg-transparent placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm',
			className
		)}
		{...rest}
	/>

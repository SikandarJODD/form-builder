...
<Popover.Root bind:open>
	...
	<Popover.Content side="left" align="start" sideOffset={6} class="relative w-[550px] rounded-xl">
		<div class="mb-1 flex items-center justify-between">
			...
			<Select.Root type="single" value={pm_command.agent} onValueChange={setAgent}>
				<Select.Trigger class="h-8 w-24 font-mono text-xs">
					{pm_command.agent}
				</Select.Trigger>
				<Select.Content>
		...
		<p class="mb-2 text-sm text-muted-foreground">
			Visit <a
				...
				class="text-primary/80 underline underline-offset-2"

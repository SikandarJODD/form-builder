...
{#snippet CodeSnippet(filename: string, code: string)}
  <div class="mt-4">
    <div
      class="flex items-center gap-1.5 p-2 border-b-0 rounded-t-lg border ml-1 w-fit bg-accent/80"
    >
    ...
    <div class="w-full max-w-2xl relative overflow-hidden scrollbar">
...
{#snippet npmcode(text: string, handleCopy: (text: string) => void)}
  <div
    class="flex items-center pl-4 pr-2 gap-x-5 py-1 min-w-64 w-fit justify-between rounded-lg bg-secondary mt-2"
  >
